...
import net.mcreator.frostpack.procedures.GmcCommandExecutedProcedure;
...
public class GmcCommand extends FrostPackElements.ModElement {
	public GmcCommand(FrostPackElements instance) {
		super(instance, 5);
	}
