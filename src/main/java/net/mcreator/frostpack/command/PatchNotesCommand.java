...
package net.mcreator.frostpack.command;
...
import net.mcreator.frostpack.procedures.PatchNotesCommandExecutedProcedure;
...
public class PatchNotesCommand extends FrostPackElements.ModElement {
	...
	private LiteralArgumentBuilder<CommandSource> customCommand() {
		return LiteralArgumentBuilder.<CommandSource>literal("pn")
	...
	private int execute(CommandContext<CommandSource> ctx) {
		...
		if (entity != null) {
			...
			});
			{
				...
				PatchNotesCommandExecutedProcedure.executeProcedure($_dependencies);
			}
		}
		return 0;
	}
