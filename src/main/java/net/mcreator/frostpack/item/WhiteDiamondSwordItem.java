...
public class WhiteDiamondSwordItem extends FrostPackElements.ModElement {
	@ObjectHolder("frostpack:whitediamondsword")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletwhitediamondsword").setRegistryName("entitybulletwhitediamondsword"));
	}
