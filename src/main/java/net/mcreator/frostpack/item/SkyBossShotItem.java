...
import net.mcreator.frostpack.procedures.SkyBossShotBulletHitsPlayernewProcedure;
import net.mcreator.frostpack.FrostPackElements;

@FrostPackElements.ModElement.Tag
public class SkyBossShotItem extends FrostPackElements.ModElement {
	@ObjectHolder("frostpack:skybossshot")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletskybossshot").setRegistryName("entitybulletskybossshot"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				SkyBossShotBulletHitsPlayernewProcedure.executeProcedure($_dependencies);
			}
		}
