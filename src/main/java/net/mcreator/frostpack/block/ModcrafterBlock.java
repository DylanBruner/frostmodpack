...
import net.mcreator.frostpack.procedures.ModcrafterclickProcedure;
...
public class ModcrafterBlock extends FrostPackElements.ModElement {
	@ObjectHolder("frostpack:modcrafter")
	public static final Block block = null;
	public ModcrafterBlock(FrostPackElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GROUND).hardnessAndResistance(3f, 15f).lightValue(0));
			setRegistryName("modcrafter");
		}
